...
latex_documents = [
    (master_doc, 'PyBEL.tex', u'PyBEL Documentation',
...
man_pages = [
    (master_doc, 'pybel', u'PyBEL Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyBEL', u'PyBEL Documentation',
     author, 'PyBEL', 'One line description of project.',
     'Miscellaneous'),
]
