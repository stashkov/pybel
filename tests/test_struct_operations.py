...
from pybel.struct.graph import left_full_join, left_node_intersection_join, left_outer_join, node_intersection, union
...
class TestLeftFullJoin(unittest.TestCase):
    ...
    def help_check_result(self, j):
        ...
        self.assertNotIn('EXTRANEOUS', j.node[p2])
